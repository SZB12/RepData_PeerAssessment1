...
```
The mean total number of steps taken each day is `r meanSteps` steps and the median total 
number of steps taken each day is `r medSteps` steps.
...
```
The total number of NAs in the dataset is `r totalNAs`.
...
With the imputed values, the mean total number of steps taken each day is `r meanStepsImputed` steps and the median total number of steps taken each day is `r medStepsImputed` steps.
